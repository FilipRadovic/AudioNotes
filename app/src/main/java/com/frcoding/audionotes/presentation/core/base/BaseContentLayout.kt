...
@Composable
fun <S: UiState, U: UiAction, A: ActionEvent> BaseContentLayout(
    modifier: Modifier,
    viewModel: BaseViewModel<S, U, A>,
    ...
    actionsEventHandler: (suspend CoroutineScope.(context: Context, actionEvent: ActionEvent) -> Unit)? = null,
